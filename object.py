...
#         self.joint = pymunk.constraints.SimpleMotor(b, b2, rate)
#         space.add(self.joint)

# class SpringJoint:
#     def __init__(self, b1, b2, space, a1 = (0, 0), a2 =(0, 0), length = 100,stif =100,damp=0,grooved=0 ):
#         self.joint = pymunk.constraints.DampedSpring(b1, b2, a1, a2, length, stif, damp)
#         self.joint.collide_bodies = False
#         space.add(self.joint)

# class GrooveJoint:
#     def __init__(self, b1, b2, space , a1 =(0,0), a2 =(0,0), anchor_b= (0,0)):
#         self.joint = pymunk.constraints.GrooveJoint(b1, b2, a1, a2, anchor_b)
#         self.joint.collide_bodies = False
#         space.add(self.joint)
